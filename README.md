...
### 🎯 روش پیشنهادی: بدون نیاز به سرور

#### مثال 1: آپلود 400 گیگ در 24 ساعت (سرویس عمومی)

```bash
python fake_upload.py -g 400 --null-service
```

#### مثال 2: آپلود سریع با 8 thread موازی

```bash
python fake_upload.py -g 400 -t 8 --null-service
```

#### مثال 3: آپلود به httpbin.org
...
```bash
python fake_upload.py -g 50 -c --null-service
```

### 🔧 با سرور خودتان

#### مثال 5: آپلود به سرور محلی
